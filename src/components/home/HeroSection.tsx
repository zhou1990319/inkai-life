...
export default function HeroSection() {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_50%_50%,_#c9a050_0%,_transparent_50%)]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-sm">
            <Sparkles size={16} />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/ai-studio"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-stone-950 font-semibold rounded-full hover:from-amber-400 hover:to-amber-500 transition-all group"
            >
              <Sparkles size={20} />
              Create Your Tattoo
