      ...
      <div className="sticky top-0 z-40 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-rose-600 to-red-800 flex items-center justify-center">
              <i className="fas fa-users text-white text-sm" />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white leading-tight">Community</h1>
              <p className="text-gray-500 text-xs">Share your tattoo art · Like · Follow · Inspire</p>
            </div>
          </div>
