...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'ai.daily_limit': 'Daily generation limit reached. Please try again tomorrow or upgrade!',
    'ai.generation_failed': 'Generation failed, please try again',
    'ai.upload_failed': 'Image upload failed, please try again',
    'ai.unlimited': 'Unlimited generations!',
    'ai.max_resolution': 'Max resolution:',
    'ai.upload_reference': 'Upload reference image',
    'ai.my_design': 'My Tattoo Design',
    'ai.link_copied': 'Image link copied to clipboard',
    'ai.check_design': 'Check out my tattoo design',
  ...
  ja: {
    ...
    'ai.daily_limit': '1日の生成回数上限に達しました。明日再度お試しいただくか、アップグレードしてください！',
    'ai.generation_failed': '生成に失敗しました。再試行してください',
    'ai.upload_failed': '画像のアップロードに失敗しました',
    'ai.unlimited': '無制限生成！',
    'ai.max_resolution': '最大解像度:',
    'ai.upload_reference': '参照画像をアップロード',
    'ai.my_design': '私のタトゥーデザイン',
    'ai.link_copied': '画像リンクをクリップボードにコピーしました',
    'ai.check_design': '私のタトゥーデザインを見てください',
  ...
  zh: {
    ...
    'ai.daily_limit': '今日生成次数已用完，请明天再来或升级会员！',
    'ai.generation_failed': '生成失败，请重试',
    'ai.upload_failed': '图片上传失败，请重试',
    'ai.unlimited': '无限次生成！',
    'ai.max_resolution': '最大分辨率:',
    'ai.upload_reference': '上传参考图片',
    'ai.my_design': '我的纹身设计',
    'ai.link_copied': '图片链接已复制到剪贴板',
    'ai.check_design': '看看我生成的纹身设计',
  ...
  pt: {
    ...
    'ai.daily_limit': 'Limite diária atingida. Tente novamente amanhã ou faça upgrade!',
    'ai.generation_failed': 'Falha na geração, tente novamente',
    'ai.upload_failed': 'Falha no upload da imagem',
    'ai.unlimited': 'Gerações ilimitadas!',
    'ai.max_resolution': 'Resolução máx:',
    'ai.upload_reference': 'Carregar imagem de referência',
    'ai.my_design': 'Meu design de tatuagem',
    'ai.link_copied': 'Link copiado para a área de transferência',
    'ai.check_design': 'Confira meu design de tatuagem',
  ...
  es: {
    ...
    'ai.daily_limit': '¡Límite diario alcanzado! Intenta mañana o mejora tu plan.',
    'ai.generation_failed': 'Error al generar, intenta de nuevo',
    'ai.upload_failed': 'Error al subir imagen',
    'ai.unlimited': '¡Generaciones ilimitadas!',
    'ai.max_resolution': 'Resolución máx:',
    'ai.upload_reference': 'Subir imagen de referencia',
    'ai.my_design': 'Mi diseño de tatuaje',
    'ai.link_copied': 'Enlace copiado al portapapeles',
    'ai.check_design': 'Mira mi diseño de tatuaje',
  ...
  de: {
    ...
    'ai.daily_limit': 'Tägliches Generierungslimit erreicht. Bitte versuche es morgen oder upgrade!',
    'ai.generation_failed': 'Generierung fehlgeschlagen, bitte erneut versuchen',
    'ai.upload_failed': 'Bild-Upload fehlgeschlagen',
    'ai.unlimited': 'Unbegrenzte Generierungen!',
    'ai.max_resolution': 'Max. Auflösung:',
    'ai.upload_reference': 'Referenzbild hochladen',
    'ai.my_design': 'Mein Tätowierungsdesign',
    'ai.link_copied': 'Bildlink in die Zwischenablage kopiert',
    'ai.check_design': 'Sieh dir mein Tätowierungsdesign an',
  ...
  ko: {
    ...
    'ai.daily_limit': '일일 생성 한도에 도달했습니다. 내일 다시 시도하거나 업그레이드하세요!',
    'ai.generation_failed': '생성 실패, 다시 시도해주세요',
    'ai.upload_failed': '이미지 업로드 실패, 다시 시도해주세요',
    'ai.unlimited': '무제한 생성!',
    'ai.max_resolution': '최대 해상도:',
    'ai.upload_reference': '참조 이미지 업로드',
    'ai.my_design': '내 타투 디자인',
    'ai.link_copied': '이미지 링크가 클립보드에 복사되었습니다',
    'ai.check_design': '내 타투 디자인을 확인해보세요',
  ...
  fr: {
    ...
    'ai.daily_limit': 'Limite quotidienne atteinte. Réessayez demain ou passez à un forfait supérieur !',
    'ai.generation_failed': 'Échec de la génération, veuillez réessayer',
    'ai.upload_failed': 'Échec du téléchargement de l\'image',
    'ai.unlimited': 'Générations illimitées !',
    'ai.max_resolution': 'Résolution max :',
    'ai.upload_reference': 'Télécharger une image de référence',
    'ai.my_design': 'Mon design de tatouage',
    'ai.link_copied': 'Lien copié dans le presse-papiers',
    'ai.check_design': 'Découvrez mon design de tatouage',
